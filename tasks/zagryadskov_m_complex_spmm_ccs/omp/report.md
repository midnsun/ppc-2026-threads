...
использованием технологии OpenMP. Реализация этого умножения направлена на распределение вычислений
...
Реализация с использованием OpenMP показывает ускорение до **7 раз**. Это демонстрирует, что алгоритм
