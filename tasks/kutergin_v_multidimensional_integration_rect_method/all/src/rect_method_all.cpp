...
#pragma omp parallel default(none) shared(h, dims, my_proc_start, my_proc_count, local_input_) reduction(+ : local_sum)
    {
      ...
      local_sum += CalculateChunkSum(my_thread_start, my_thread_start + my_thread_count, h);
    }
  }
